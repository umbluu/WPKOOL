<div class="asap-section" id="asap-section-how" <?php if ($active_tab != 'how') { ?>style="display: none;"<?php } ?>>
    ...
    <p>Also please make sure you follow below steps after creating app.<br>Navigate to Apps > Settings > Edit settings > Website > Site URL.<br/> Set the site url as : <input type="text" readonly="readonly" onfocus="this.select();" value="<?php echo site_url(); ?>" style="width: 100%;"/></p>
