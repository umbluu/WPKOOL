...
<div id="footer-nav">  <!-- Copyright notice on the bottom -->
	<span>
		<?php
		$copyright = get_theme_mod( 'rokophotolite_footer_copyrights', __( 'Awesome Photography. All Rights Reserved', 'rokophotolite' ) );
		if ( ! empty( $copyright ) ) {
		...
		<br/>
		<?php
		$powered = get_theme_mod( 'rokophotolite_footer_powerdby', __( '<a href="https://themeisle.com/themes/rokophoto-lite/" target="_blank" rel="nofollow">RokoPhoto Lite</a> powered by <a href="https://wordpress.org/" target="_blank" rel="nofollow">WordPress</a>', 'rokophotolite' ) );
		if ( ! empty( $powered ) ) {
